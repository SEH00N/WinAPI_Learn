...
void ProgressBar::Init(wstring frontImage, wstring backImage, float x, float y, int width, int height, bool horizontal)
{
...
void ProgressBar::Init(shared_ptr<Image> frontImage, shared_ptr<Image> backImage, float x, float y, int width, int height, bool horizontal)
{
